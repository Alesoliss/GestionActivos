...
namespace SistemaActivos.DataAccess.Repository
{
    public class EstadosCivilesRepository : IRepository<tbEstadosCiviles>
    {
        ...
        public IEnumerable<tbEstadosCiviles> FindEstadoCivil(int codigo)
        {
            string sql = ScriptDataBase.EstadosCivilesBuscar;
            List<tbEstadosCiviles> result = new List<tbEstadosCiviles>();
            using (var db = new SqlConnection(SistemaActivosContext.ConnectionString))
            {
                var parametro = new DynamicParameters();
                parametro.Add("EstD_Id", codigo);
        ...
        {
            string sql = ScriptDataBase.EstadosCivilesEliminar;
        ...
        {
            string sql = ScriptDataBase.EstadosCivilesDetalles ;
            ...
            using (var db = new SqlConnection(SistemaActivosContext.ConnectionString))
            {
                var parametro = new DynamicParameters();
                parametro.Add("EstD_Id", id);
                result = db.Query<tbEstadosCiviles>(sql, parametro, commandType: CommandType.StoredProcedure).ToList();
                return result;
            }
        }
    }
