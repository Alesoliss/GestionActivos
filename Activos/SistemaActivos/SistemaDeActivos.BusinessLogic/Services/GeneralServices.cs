...
namespace SistemaDeActivos.BusinessLogic
{
    public class GeneralServices
    {
        ...
        public IEnumerable<tbEstadosCiviles> BuscarEstadoCivil(int codigo)
        {
            try
            {
                return _estadosCivilesRepository.FindEstadoCivil(codigo);
        ...
        public ServiceResult BuscarEstadosDetalle(int codigo)
        {
            var result = new ServiceResult();
            try
            {
                var list = _estadosCivilesRepository.FindDetalle(codigo);
                return result.Ok(list);
        ...
        public IEnumerable<tbMunicipios> BuscarMunicipio (string codigo)
        {
            try
            {
                return _municipiosRepository.FindMuni(codigo);
        ...
        public ServiceResult DetalleMunicipio(string codigo)
        {
            var result = new ServiceResult();
            try
            {
                var list = _municipiosRepository.FindDetalle(codigo);
                return result.Ok(list);
        ...
        public ServiceResult ActualizarSucursal(tbSucursales item)
        {
            var result = new ServiceResult();
            try
            {
                var lost = _sucursalesRepository.Update(item);
        ...
        public ServiceResult BuscarDetalleSucursal(int codigo)
        {
            ...
            try
            {
                var list = _sucursalesRepository.FindDetalleSucursal(codigo);
                return result.Ok(list);
        ...
        public IEnumerable<tbSucursales> BuscarSucursal(int codigo)
        {

            try
            {
                return _sucursalesRepository.FindSucursal(codigo);
        ...
        public ServiceResult EliminarSucursal(int id)
        {
            ...
            try
            {
                var lost = _sucursalesRepository.EliminarSucursales(id);
                if (lost.CodeStatus > 0)
                {
                    return result.Ok(lost);
                }
